...
overview; `query_entities` searches text and blocks in bounded pages and can inspect
...
their own context-window policies. Paper coordinates may be scaled, so the assistant
